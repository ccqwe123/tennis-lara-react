...
function ButtonCombo({
  ...
  VariantProps<typeof buttonComboVariants> & {
    asChild?: boolean
  }) {
  ...
  return (
    <Comp
      ...
      data-size={size}
      className={cn(buttonComboVariants({ variant, size, className }))}
      {...props}
    />
  )
}

export { ButtonCombo, buttonComboVariants }
