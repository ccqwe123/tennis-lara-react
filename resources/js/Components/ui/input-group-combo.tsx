...
import { InputCombo } from "@/Components/ui/input-combo"
import { TextareaCombo } from "@/Components/ui/textarea-combo"

function InputGroupCombo({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
function InputGroupComboButton({
  className,
  type = "button",
  variant = "ghost",
  size = "xs",
  ...props
}: Omit<React.ComponentProps<typeof ButtonCombo>, "size"> &
...
function InputGroupComboText({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      className={cn(
...
function InputGroupComboTextarea({
  className,
  ...props
