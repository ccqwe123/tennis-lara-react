...
export default function BookingsIndex({ auth, bookings, filters, sort, stats }: PageProps) {
    ...
    const buildParams = (overrides: Record<string, string> = {}) => {
        ...
        const finalPaymentStatus = overrides.paymentStatus !== undefined ? overrides.paymentStatus : paymentStatus
        ...
        if (finalPaymentStatus !== "all") params.paymentStatus = finalPaymentStatus
    ...
    const handlePaymentStatusChange = (value: string) => {
        ...
        router.get(route("bookings.index"), buildParams({ paymentStatus: value }), { preserveState: true })
    }
