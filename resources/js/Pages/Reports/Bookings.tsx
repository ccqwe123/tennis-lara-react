...
import { Calendar as CalendarIcon, FileDown, Filter, Printer, Download, Search, Loader2 } from "lucide-react"
...
export default function BookingReports({ auth, bookings, filters, stats }: Props) {
    ...
    const handleExportCSV = () => {
        const headers = ['Date', 'Time', 'Customer', 'Type', 'Games', 'Trainer', 'Priest', 'Picker', 'Picker Fee', 'Status', 'Amount']
        ...
        link.setAttribute('download', `booking-report-${dateTag}.csv`)
