...
export default function EditTournament({ auth, tournament, errors = {} }: PageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/tournaments/${tournament.id}`, formData, {
            onSuccess: () => {
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-center justify-end gap-4 pt-4">
                                    ...
                                    >
                                        {processing ? 'Updating...' : 'Update Tournament'}
                                    </Button>
                                </div>
                            </form>
                        </CardContent>
